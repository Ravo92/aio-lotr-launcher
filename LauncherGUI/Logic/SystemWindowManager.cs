...
{
    internal class SystemWindowManager
    {
        internal static void UpdateWindow(IntPtr handle, int xPos, int yPos, int xRes, int yRes, bool removeBorder = true)
        {
        ...
        internal static void ActivateWindow(IntPtr handle)
        {
            NativeMethods.ShowWindow(handle, NativeMethods.SW_RESTORE);
            NativeMethods.SetForegroundWindow(handle);
        ...
        private static bool IsWindowFullscreen(IntPtr handle)
        {
            Rect rect = default;
