...
namespace PatchLauncher
{
    public partial class InstallPathDialog : Form
    {
        ...
        public InstallPathDialog()
        {
            ...
            BtnChoose.BackgroundImage = ConstStrings.C_BFME2_BUTTONIMAGE_NEUTR;
            BtnChoose.Font = FontHelper.GetFont(0, 14);
            BtnChoose.ForeColor = Color.FromArgb(168, 190, 98);

            BtnAccept.FlatAppearance.BorderSize = 0;
            BtnAccept.FlatStyle = FlatStyle.Flat;
            BtnAccept.BackColor = Color.Transparent;
            BtnAccept.BackgroundImage = ConstStrings.C_BFME2_BUTTONIMAGE_NEUTR;
            BtnAccept.Font = FontHelper.GetFont(0, 14);
            BtnAccept.ForeColor = Color.FromArgb(168, 190, 98);

            TxtInstallPath.BackColor = Color.FromArgb(0, 0, 0);
            TxtInstallPath.Font = FontHelper.GetFont(0, 16);
            TxtInstallPath.ForeColor = Color.FromArgb(168, 190, 98);
            ...
            ChkDesktopShortcut.ForeColor = Color.FromArgb(168, 190, 98);

            if (FlagCreateDesktopShortcut)
            {
                ChkDesktopShortcut.Image = Helper.Properties.Resources.BFME2CHK_Selected;
            }
            else
            {
                ChkDesktopShortcut.Image = Helper.Properties.Resources.BFME2CHK_Unselected;
            }
            ...
            ChkStartMenuShortcut.ForeColor = Color.FromArgb(168, 190, 98);

            if (FlagCreateStartMenuShortcut)
            {
                Settings.Default.CreateStartMenuShortcut = true;
                ChkStartMenuShortcut.Image = Helper.Properties.Resources.BFME2CHK_Selected;
            }
            else
            {
                Settings.Default.CreateStartMenuShortcut = false;
                ChkStartMenuShortcut.Image = Helper.Properties.Resources.BFME2CHK_Unselected;
            }

            PibLanguageSupport.Image = Helper.Properties.Resources.BFME2LanguageSupportTransparent;
            PibPathBorder.Image = Helper.Properties.Resources.BFME2BorderRectangleSmallest;
            ...
            else if (RegistryService.ReadRegKeyBFME2("InstallPath") != "ValueNotFound")
            {
                TxtInstallPath.Text = RegistryService.ReadRegKeyBFME2("InstallPath");
            }
            else
            {
                TxtInstallPath.Text = Path.Combine(Application.StartupPath, ConstStrings.C_GAMEINSTALLFOLDER_NAME, ConstStrings.C_GAMEFOLDER_NAME_BFME2);
            }
        ...
        private void BtnChoose_Click(object sender, EventArgs e)
        {
            ...
            {
                TxtInstallPath.Text = Path.Combine(_installPath.SelectedPath, ConstStrings.C_GAMEINSTALLFOLDER_NAME, ConstStrings.C_GAMEFOLDER_NAME_BFME2);
            }
        }

        private void BtnChoose_MouseDown(object sender, MouseEventArgs e)
        {
            BtnChoose.BackgroundImage = ConstStrings.C_BFME2_BUTTONIMAGE_CLICK;
            BtnChoose.ForeColor = Color.FromArgb(168, 190, 98);
        ...
        {
            BtnChoose.BackgroundImage = ConstStrings.C_BFME2_BUTTONIMAGE_HOVER;
        ...
        {
            BtnAccept.BackgroundImage = ConstStrings.C_BFME2_BUTTONIMAGE_CLICK;
            BtnAccept.ForeColor = Color.FromArgb(168, 190, 98);
            Task.Run(() => SoundPlayerHelper.PlaySoundClick());
        }
        ...
        {
            BtnAccept.BackgroundImage = ConstStrings.C_BFME2_BUTTONIMAGE_HOVER;
        ...
        private void ChkDesktopShortcut_Click(object sender, EventArgs e)
        {
            ...
            {
                ChkDesktopShortcut.Image = Helper.Properties.Resources.BFME2CHK_UnselectedHover;
                FlagCreateDesktopShortcut = false;
            }
            else
            {
                ChkDesktopShortcut.Image = Helper.Properties.Resources.BFME2CHK_SelectedHover;
        ...
        private void ChkStartMenuShortcut_Click(object sender, EventArgs e)
        {
            ...
            {
                ChkStartMenuShortcut.Image = Helper.Properties.Resources.BFME2CHK_UnselectedHover;
                FlagCreateStartMenuShortcut = false;
            }
            else
            {
                ChkStartMenuShortcut.Image = Helper.Properties.Resources.BFME2CHK_SelectedHover;
