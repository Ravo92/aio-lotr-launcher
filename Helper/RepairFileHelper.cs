namespace Helper
{
    public class RepairFileHelper
    {
        public static Task RepairFeature(string assemblyName)
        {
            try
            {
                if (Directory.Exists(RegistryService.GameInstallPath(assemblyName)))
                {
                    ...
                    LogHelper.LoggerRepairFile.Information(string.Format("Deleted Folder: {0}", RegistryService.GameInstallPath(assemblyName)));
                }
        ...
        //            {
        //                LogHelper.LoggerRepairFile.Information(string.Format("File {0} has the correct value: {1}", fileName.Key, shouldMD5Value));
        //            }
        //            else
        //            {
        //                LogHelper.LoggerRepairFile.Information(string.Format("File {0} ist corrupted and will be reaquired... Value: {1}", fileName.Key, isMD5Value));
        //                FlagIsCorrupt = true;
        //                break;
        //            }
        //        }
        ...
        //                {
        //                    LogHelper.LoggerRepairFile.Information(string.Format("Deleted the game folder \"{0}\" sucessfully", gameInstallPath));
        //                }
        //                else
        //                {
        //                    LogHelper.LoggerRepairFile.Error(string.Format("Was not able to delete the folder \"{0}\".", gameInstallPath));
        //                }
        //            }
        //
        //            if (File.Exists(Path.Combine(Application.StartupPath, ConstStrings.C_DOWNLOADFOLDER_NAME, ConstStrings.C_MAINGAMEFILE_ZIP)))
        //            {
        //                LogHelper.LoggerRepairFile.Information(string.Format("Checking file \"{0}\"...", ConstStrings.C_MAINGAMEFILE_ZIP));
        ...
        //                    LogHelper.LoggerRepairFile.Warning(string.Format("The file \"{0}\" was corrupted and will be reaquired...", ConstStrings.C_MAINGAMEFILE_ZIP));
        //                }
        //                LogHelper.LoggerRepairFile.Information(string.Format("File \"{0}\" is okay. No action needed.", ConstStrings.C_MAINGAMEFILE_ZIP));
        //            }
        //            if (File.Exists(Path.Combine(Application.StartupPath, ConstStrings.C_DOWNLOADFOLDER_NAME, _languageSettings.LanguagPackName)))
        //            {
        //                LogHelper.LoggerRepairFile.Information(string.Format("Checking file \"{0}\"...", _languageSettings.LanguagPackName));
        ...
        //                {
        //                    File.Delete(Path.Combine(Application.StartupPath, ConstStrings.C_DOWNLOADFOLDER_NAME, ConstStrings.C_MAINGAMEFILE_ZIP));
        //                    LogHelper.LoggerRepairFile.Warning(string.Format("The file \"{0}\" was corrupted and will be reaquired...", _languageSettings.LanguagPackName));
        //                }
        //                LogHelper.LoggerRepairFile.Information(string.Format("File \"{0}\" is okay. No action needed.", _languageSettings.LanguagPackName));
        //            }
        //            LogHelper.LoggerRepairFile.Information("Check for EAX-Support...");
        //            if (EAXSupport)
        //            {
        //                LogHelper.LoggerRepairFile.Information("EAX-Support is active... Installing neccessary files...");
        ...
        //            else
        //            {
        //                LogHelper.LoggerRepairFile.Information("EAX support disabled via launcher... no action needed.");
        //            }
        //            LogHelper.LoggerRepairFile.Information("We are now renewing every file...");
        //            await WinFormsMainGUI.InstallUpdatRepairRoutine();
        //        }
        //        else
        //        {
        //            LogHelper.LoggerRepairFile.Information(string.Format("Detected game language: \"{0}\"", _languageSettings.RegistrySelectedLanguage));
        //            LogHelper.LoggerRepairFile.Information(string.Format("Reinstalling installed language: \"{0}\" ...", _languageSettings.RegistrySelectedLanguage));
        //            if (File.Exists(Path.Combine(Application.StartupPath, ConstStrings.C_DOWNLOADFOLDER_NAME, _languageSettings.LanguagPackName)))
        //            {
        //                LogHelper.LoggerRepairFile.Information(string.Format("Checking file \"{0}\"...", _languageSettings.LanguagPackName));
        //                if (MD5Tools.CalculateMD5(Path.Combine(Application.StartupPath, ConstStrings.C_DOWNLOADFOLDER_NAME, _languageSettings.LanguagPackName)) != XMLFileHelper.GetXMLGameLanguageMD5Hash(_languageSettings.RegistrySelectedLocale))
        ...
        //            LogHelper.LoggerRepairFile.Information(string.Format("Copied German translation for 2.22 \"{0}\" into \"{1}\"", ConstStrings.C_GERMANLANGUAGE_PATCH_FILE, gameInstallPath));
        //        }
