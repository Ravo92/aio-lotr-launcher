...
namespace PatchLauncher
{
    public partial class InstallPathDialog : Form
    {
        ...
        public InstallPathDialog()
        {
            ...
            LblFreeSpace.ForeColor = Color.FromArgb(192, 145, 69);
            LblFreeSpace.BackColor = Color.Transparent;

            LblNeededSpace.Font = FontHelper.GetFont(0, 12);
            LblNeededSpace.ForeColor = Color.FromArgb(192, 145, 69);
            ...
            else if (RegistryService.ReadRegKeyBFME1("InstallPath") != "ValueNotFound")
            {
                TxtInstallPath.Text = RegistryService.ReadRegKeyBFME1("InstallPath");
            }
            else
            {
